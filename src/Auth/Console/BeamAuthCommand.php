...
namespace Beam\Auth\Console;

use Illuminate\Console\Command;
use Illuminate\Console\AppNamespaceDetectorTrait;

class BeamAuthCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'beam:auth {--views : Only scaffold the authentication views}';
     ...
     * @var string
     */
    protected $description = 'Scaffold basic login and registration views and routes for Beam application';
    ...
    protected $controllers = [
        'auth/ActivationController.stub' => 'Auth/ActivationController.php',
    ...
    {
        foreach ($this->controllers as $stub => $name) {
            file_put_contents(
                app_path('Http/Controllers/'.$name),
